...
class evaluation:
    ...
    def Modularity(self,graph, solution, locus = True, truth = False):
        ...
        #leiden_mod = leiden_coms.link_modularity().score


        #print(community_part)
        #print (leiden_mod)
        #leiden_coms = algorithms.leiden(graph)
        #leiden_mod = leiden_coms.normalized_cut() using
        #leiden_mod = leiden_coms.average_internal_degree()
        #print(leiden_mod)
        #return leiden_coms
        return community.modularity(node_to_community, graph)
        #return leiden_mod.max

    @classmethod
    def Nomalized_Cut(self, graph, solution, locus = True, truth = False):
        leiden_coms = algorithms.leiden(graph)
        leiden_mod = leiden_coms.normalized_cut()
        return leiden_mod.score
    ...
    @classmethod #adjusted rand score
