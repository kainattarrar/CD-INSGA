...
if __name__ == '__main__':
    ...
    normalized_cut = list(map(lambda x: round(evaluation.Nomalized_Cut(g[x], pop_solutions_tmoga[x]), 3), range(len(g))))
    print("Normalized Cut for each snapshot:", normalized_cut)
